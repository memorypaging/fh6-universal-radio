...
$deps = @(
    ...
    @{ Url = "https://raw.githubusercontent.com/richgel999/bc7enc/master/bc7enc.h"; Out = "bc7enc\bc7enc.h"; Base = $tp },
    @{ Url = "https://raw.githubusercontent.com/richgel999/bc7enc/master/bc7enc.c"; Out = "bc7enc\bc7enc.c"; Base = $tp },
